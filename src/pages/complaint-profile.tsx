        ...
        <div className="border-b border-secondary bg-primary px-4 sm:px-6 lg:px-8 pt-5 pb-4 shrink-0">
          <div className="flex items-center gap-3 flex-wrap">
            <div className="flex-1 min-w-0">
              <h1 className="text-lg font-semibold text-primary" style={{ fontFamily: "'Metrophobic', sans-serif" }}>{COMPLAINT.customer.title} {COMPLAINT.customer.firstName} {COMPLAINT.customer.lastName}</h1>
              <div className="flex items-center gap-1.5 mt-0.5 text-xs text-secondary">
                <span>{COMPLAINT.statusLabel}</span>
                <span className="text-quaternary">|</span>
                <span>{COMPLAINT.info.type}</span>
                <span className="text-quaternary">|</span>
                <span>Created {COMPLAINT.info.createdOn}</span>
              </div>
            </div>
            <div className="flex items-center gap-1.5 flex-wrap ml-auto">
              <StatusButton />
              <DropdownButton label="Actions" icon={RefreshCw01} items={[{ label: "SMS", icon: MessageChatSquare }, { label: "Email", icon: Send01 }, { label: "Schedule", icon: Calendar }, { label: "Upload Files", icon: Upload01 }]} />
