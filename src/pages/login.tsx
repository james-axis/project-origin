        ...
        <section className="grid min-h-screen grid-cols-1 bg-primary lg:grid-cols-[640px_1fr]">
                    ...
                    <div className="flex w-full flex-col gap-8 sm:max-w-90">
                        <div className="flex flex-col gap-6 md:gap-16">
                            ...
                            <div className="md:hidden">
                                <h1 className="text-display-xs font-normal text-primary" style={{ fontFamily: "'Metrophobic', sans-serif" }}>Log in</h1>
                            </div>
            ...
            <div className="relative hidden w-full gap-20 overflow-hidden bg-tertiary pt-24 pr-16 pl-20 lg:flex lg:flex-col">
                <figure className="flex max-w-3xl flex-col gap-6">
                    <blockquote>
                        <p className="text-display-sm font-normal text-primary" style={{ fontFamily: "'Metrophobic', sans-serif" }}>
                    ...
                    <figcaption className="flex items-start gap-3">
                        <div className="flex-1">
                            <p className="text-lg font-semibold text-primary">— Jon Doe</p>
                            <cite className="text-md font-medium text-tertiary not-italic">Senior Financial Adviser</cite>
                        </div>
                    ...
                    <div className="absolute top-0 left-0 h-170.5 rounded-[9.03px] bg-primary p-[0.9px] shadow-lg ring-[0.56px] ring-utility-gray-300 ring-inset md:rounded-[26.95px] md:p-[3.5px] md:ring-[1.68px]">
                        <div className="h-full rounded-[7.9px] bg-primary p-0.5 shadow-modern-mockup-inner-md md:rounded-[23.58px] md:p-1 md:shadow-modern-mockup-inner-lg">
                            <div className="relative h-full overflow-hidden rounded-[6.77px] bg-utility-gray-50 ring-[0.56px] ring-utility-gray-200 md:rounded-[20.21px] md:ring-[1.68px]">
                                <img src="https://www.untitledui.com/marketing/screen-mockups/dashboard-desktop-mockup-light-01.webp" className="h-full max-w-none object-cover object-left-top dark:hidden" alt="Axis CRM dashboard" />
                                <img src="https://www.untitledui.com/marketing/screen-mockups/dashboard-desktop-mockup-dark-01.webp" className="h-full max-w-none object-cover object-left-top not-dark:hidden" alt="Axis CRM dashboard" />
                            </div>
                        </div>
                    </div>
                </div>
